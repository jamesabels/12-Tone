...
var key = {
  ...
  major: {
    C: {
      ...
      chords: ["C-Major", "D-Minor", "E-Minor", "F-Major", "G-Major", "A-Minor", "B-Minor-Dim"],
      color: red
    },
    CSharp: {
      ...
      chords: ["C-Sharp-Major", "D-Sharp-Minor", "E-Sharp-Minor", "F-Sharp-Major", "G-Sharp-Major", "A-Sharp-Minor", "B-Sharp-Minor-Dim"],      
      color: red
    },
    D: {
      ...
      chords: ["D-Major", "E-Sharp-Minor", "F-Sharp-Minor", "G-Major", "A-Major", "B-Minor", "C-Sharp-Minor-Dim"],   
      color: yellow
    },
    DSharp: {
      ...
      chords: ["D-Major", "E-Flat-Minor", "F-Minor", "G-Major", "A-Flat-Major", "B-Flat-Minor", "C-Minor-Dim"],      
      color: yellow
    },
    E: {
      ...
      chords: ["E-Major", "F-Sharp-Minor", "G-Sharp-Minor", "A-Major", "B-Flat-Major", "C-Sharp-Minor", "D-Sharp-Minor-Dim"],
      color: paleBlue
    },
    F: {
      ...
      chords: ["F-Major", "G-Minor", "A-Minor", "B-Flat-Major", "C-Major", "D-Minor", "E-Minor-Dim"],  
      color: darkRed
    },
    FSharp: {
      ...
      chords: ["F-Sharp-Major", "G-Sharp-Minor", "A-Sharp-Minor", "B-Major", "C-Sharp-Major", "D-Sharp-Minor", "E-Sharp-Minor-Dim"],          
      color: darkRed
    },
    G: {
      ...
      chords: ["G-Major", "A-Minor", "B-Minor", "C-Major", "D-Major", "E-Minor", "F-Sharp-Minor-Dim"],                
      color: orange
    },
    GSharp: {
    ...
    A: {
      ...
      chords: ["A-Major", "B-Minor", "C-Sharp-Minor", "D-Major", "E-Major", "F-Sharp-Minor", "G-Sharp-Minor-Dim"],      
      color: purple
    },
    ASharp: {
      ...
      chords: ["A-Major", "B-Flat-Minor", "C-Minor", "D-Major", "E-Flat-Major", "F-Minor", "G-Minor-Dim"],            
      color: purple
    },
    B: {
      ...
      chords: ["B-Major", "C-Sharp-Minor", "D-Minor", "E-Major", "F-Sharp-Major", "G-Sharp-Minor", "A-Sharp-Minor-Dim"],                  
      color: paleBlue
    }
  },
  minor: {
    C: {
      ...
      chords: ["C-Minor", "D-Minor-Dim", "E-Flat-Major", "F-Minor", "G-Major", "A-Flat-Major", "B-Major"],    
      color: red
    },
    CSharp: {
      ...
      chords: ["C-Sharp-Minor", "D-Sharp-Minor-Dim", "E-Major", "F-Sharp-Minor", "G-Sharp-Major", "A-Major", "B-Major"],                  
      color: red
    },
    D: {
      ...
      chords: ["D-Minor", "E-Minor-Dim", "F-Major", "G-Minor", "A-Major", "B-Flat-Major", "C-Major"],                        
      color: yellow
    },
    DSharp: {
      ...
      chords: ["D-Sharp-Minor", "E-Sharp-Minor-Dim", "F-Sharp-Major", "G-Sharp-Minor", "A-Sharp-Major", "B-Major", "C-Sharp-Major"],                        
      color: yellow
    },
    E: {
      ...
      chords: ["E-Minor", "F-Sharp-Minor-Dim", "G-Major", "A-Minor", "B-Major", "C-Major", "D-Major"],                        
      color: paleBlue
    },
    F: {
      ...
      chords: ["F-Minor", "G-Minor-Dim", "A-Flat-Major", "B-Flat-Minor", "C-Major", "D-Flat-Major", "E-Flat-Major"],                        
      color: darkRed
    },
    FSharp: {
      ...
      chords: ["F-Sharp-Minor", "G-Sharp-Minor-Dim", "A-Major", "B-Minor", "C-Sharp-Major", "D-Major", "E-Major"],                        
      color: darkRed
    },
    G: {
      ...
      chords: ["G-Minor", "A-Minor-Dim", "B-Flat-Major", "C-Minor", "D-Major", "E-Flat-Major", "F-Major"],                        
      color: orange
    },
    GSharp: {
      ...
      chords: ["G-Sharp-Minor", "A-Sharp-Minor-Dim", "B-Sharp-Major", "C-Sharp-Minor", "D-Sharp-Major", "E-Sharp-Major", "F-Sharp-Major"],                        
      color: orange
    },
    A: {
      keyChar: "Grumbler, heart squeezed until it suffocates; wailing lament, difficult struggle; in a word, the color of this key is everything struggling with difficulty.",
      ...
      chords: ["A-Minor", "B-Minor-Dim", "C-Major", "D-Minor", "E-Major", "F-Major", "G-Major"],                        
      color: purple
    },
    ASharp: {
      ...
      chords: ["A-Sharp-Minor", "B-Sharp-Minor-Dim", "C-Sharp-Major", "D-Sharp-Minor", "E-Sharp-Major", "F-Sharp-Major", "G-Sharp-Major"],                        
      color: purple
    },
    B: {
      ...
      chords: ["B-Minor", "C-Sharp-Minor-Dim", "D-Sharp-Major", "E-Minor", "F-Sharp-Major", "G-Sharp-Major", "A-Sharp-Major"],                        
      color: paleBlue
    },
  }
};